    ...
    <header id="main-header">
        <div id="header-right">
            ...
            <ul>
                ...
                <li><a href="lenta.jsp"><img src="images/1.png" width="44" height="38"></a></li> </ul>
        </div>
        <div class="clear"></div>
    </header>
    ...
    <div id="content">
        ...
        <main>
            ...
            try{
                ...
                String strQuery = "select posttext, id_user from twit_table";
        ...
        %>
            <div class="tweet-content">
                ...
                <div class="tweet">
                    <div class="from"><a href="#"><%=rs.getString(2)%></a> </div>
